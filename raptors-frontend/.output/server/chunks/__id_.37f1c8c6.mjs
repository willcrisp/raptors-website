...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<h1 class="font-bold text-xl mb-2">Super awesome article for: ${serverRenderer.exports.ssrInterpolate($data.article.Title)}</h1></div>`);
}
...
//# sourceMappingURL=__id_.37f1c8c6.mjs.map
